...
def parse_args():
    ...
    parser.add_argument('--output-dir', type=str, default='/data_new/luxiaoxi/dataset/medical_depth_output/fundus_dong/Mast3R_new_seg')
...
def endoscope_evaluation(args):
    ...
    for img_path in metric_logger.log_every(img_list, print_freq=1, header=header):
        ...
        depth_metric = eval_depth_numpy(pred, gt, left_msk)
