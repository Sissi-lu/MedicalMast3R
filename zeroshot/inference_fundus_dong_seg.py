...
def parse_args():
    ...
    parser.add_argument('--output-dir', type=str, default='/data_new/luxiaoxi/dataset/medical_depth_output/fundus_dong/MASt3R_1006_finetune_w_qualitative_embed_head_decoder_true_dataset_seg')
