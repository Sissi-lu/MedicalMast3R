...
folder_path = '/data_new/luxiaoxi/dataset/medical_depth/final_version_processed/s3_processed/left/depth_colored'  # 图片文件夹
name = '00125'  # 查找文件名包含的字符串
mask_path = '/data_new/luxiaoxi/dataset/medical_depth/final_version_processed/s3_processed/left/valid_region_mask/00125.png'  # mask 文件路径
...
for filename in os.listdir(folder_path):
    if name in filename and filename.lower().endswith('.png'):
        ...
        save_path = os.path.join("/data_new/luxiaoxi/dataset/medical_depth/final_version_processed", save_name)
