...
def parse_args():
    ...
    parser.add_argument('--model-name', type=str, default='/data_new/luxiaoxi/code_proj/MedicalMast3R/checkpoints/fundusdong_mast3r_1001_head_half_decoder_change_dataset/checkpoint-best.pth')
    ...
    parser.add_argument('--output-dir', type=str, default='/data_new/luxiaoxi/dataset/medical_depth_output/fundus_dong/MASt3R_1001_finetune_w_qualitative_head_half_decoder_change_dataset')
