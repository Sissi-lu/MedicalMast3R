...
folder_path = '/data_new/luxiaoxi/dongbingwen/pred/dav2_test_zeroshot'   # 图片文件夹
name = '00423'                  # 查找文件名包含的字符串
mask_path = '/data_new/luxiaoxi/dataset/medical_depth/final_version_processed/s7_processed/left/valid_region_mask/00423.png'   # mask 文件路径
