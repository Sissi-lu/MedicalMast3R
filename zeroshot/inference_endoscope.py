...
def parse_args():
    ...
    parser.add_argument('--input-dir', type=str, default='/data/luxiaoxi/dataset/medical_depth/SCARED_keyframe_nearest_256')
    parser.add_argument('--data-name', type=str, help='scared, abs, servct', default='scared')
